...
.event-date-section-tittle.cancel-top-margin {
  margin-top: 0px;
}
...
.cottageclass-is-list-item-text {
  margin-left: 24px;
}

.cottage-class-is-list {
  display: -webkit-box;
  display: -webkit-flex;
  display: -ms-flexbox;
  display: flex;
...
.cottageclass-is-list-item-image {
  max-width: 230px;
  margin-bottom: 16px;
}
...
@media (max-width: 767px) {
  ...
  .p-center-black.desktop-align-left {
    font-size: 14px;
    line-height: 21px;
  }
