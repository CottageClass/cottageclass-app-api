          ...
          <div class="top-card-summary-info">
            <div class="top-card-column-1">
              ...
              <div class="top-card-subtitle"><span>{{ user.neighborhood || user.adminAreaLevel1 }}</span> |
                <span v-if="user && user.childAgesInMonths && user.childAgesInMonths.length > 0" class="providerp-children">
                    <ChildAges :childAgesInMonths="user.childAgesInMonths" singular="child" plural="children" prefix="Parent to "/>.
                </span>
              </div>
