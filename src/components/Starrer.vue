...
<li class="attendee__list-item">
  <router-link
    :to="{name: 'ProviderProfile', params: {id: user.userId}}"
    class="attendee__link-wrapper w-inline-block">
     <AvatarImage className="attendee__photo"
                   ...
                   imageSize="100"/>
    <img :src="starIcon" width="24" height="24" alt="" class="attendees__going-icon-medium" />
...
import starIcon from '@/assets/interested-round.svg'
