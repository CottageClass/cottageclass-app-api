...
.form-location-input {
  ...
  background-image: url("https://assets.website-files.com/5c6c7d4a75c1e54694ed12d1/5cb74731476af65c8b56d2ff_search-black-20.svg"), -webkit-gradient(linear, left top, left bottom, from(#fff), to(#fff));
