class AddTokensToUsers < ActiveRecord::Migration[5.2]
  # devise_token_auth config: https://github.com/lynndylanhurley/devise_token_auth/blob/master/docs/faq.md#i-already-have-a-user-how-can-i-add-the-new-fields
  def up
