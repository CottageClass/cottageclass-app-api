...
ActiveRecord::Schema.define(version: 20_191_205_193_503) do
  ...
  create_table 'conversations', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[initiator_id recipient_id], name: 'index_conversations_on_initiator_id_and_recipient_id', unique: true
  ...
  create_table 'participants', force: :cascade do |t|
    ...
    t.datetime 'created_at'
    t.datetime 'updated_at'
    t.index %w[participable_type participable_id user_id], name: 'index_participants_on_participable_type_participable_id_user_id', unique: true
  end
  ...
  create_table 'places', force: :cascade do |t|
    ...
    t.index %w[google_id apartment_number], name: 'index_places_google_id_apartment_number', unique: true
    t.index %w[latitude longitude], name: 'index_places_on_latitude_and_longitude'
  ...
  create_table 'stars', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[giver_id starable_type starable_id], name: 'index_stars_on_starable_type_starable_id_giver_id', unique: true
    t.index ['giver_id'], name: 'index_stars_on_giver_id'
    t.index %w[starable_type starable_id], name: 'index_stars_on_starable_type_and_starable_id'
  end
